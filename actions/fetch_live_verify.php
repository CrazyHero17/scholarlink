...
$query = "SELECT sd.SubmittedDocID, dr.DocumentName, u.FirstName, u.LastName, u.Major, sd.VerificationStatus
          ...
          JOIN users u ON a.UserID = u.UserID"; // Shows all statuses for master verification
